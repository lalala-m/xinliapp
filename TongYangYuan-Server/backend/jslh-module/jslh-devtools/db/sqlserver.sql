...
INSERT INTO sys_params(id, param_code, param_value, param_type, remark, del_flag, creator, create_date, updater, update_date) VALUES (1067246875800000072, 'DEV_TOOLS_PARAM_KEY', '{"packageName":"com.jslh","version":"3.0","author":"Mark","email":"sunlightcs@gmail.com","backendPath":"D:\\jslhio\\jslh-cloud-tenant\\jslh-admin","frontendPath":"D:\\jslhio\\jslh-cloud-tenant-admin"}', 0, '代码生成器配置信息', 0, 1067246875800000001, getdate(), 1067246875800000001, getdate());
...
INSERT INTO gen_datasource(id, db_type, conn_name, conn_url, username, password, status, create_date) VALUES (1302855887882412034, 'MySQL', '本地', 'jdbc:mysql://localhost:3306/jslh_cloud?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true', 'jslh', '123456', 0, getdate());
...
INSERT INTO gen_test_data(id, username, real_name, gender, email, notice_type, content, creator, create_date, updater, update_date) VALUES (1067246875800000001, 'sunlightcs', 'Mark', 0, 'root@jslh.io', 0, '<p>晶石领航代码生成器！</p>', 1067246875800000001, getdate(), 1067246875800000001, getdate());
