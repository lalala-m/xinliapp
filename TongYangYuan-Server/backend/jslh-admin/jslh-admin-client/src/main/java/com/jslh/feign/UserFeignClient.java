...
import com.jslh.feign.fallback.UserFeignClientFallbackFactory;
 ...
 */
@FeignClient(name = ServiceConstant.JSLH_ADMIN_SERVER, contextId = "UserFeignClient", fallbackFactory = UserFeignClientFallbackFactory.class)
