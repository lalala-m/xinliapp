...
import com.jslh.feign.fallback.ParamsFeignClientFallbackFactory;
 ...
 */
@FeignClient(name = ServiceConstant.JSLH_ADMIN_SERVER, contextId = "ParamsFeignClient", fallback = ParamsFeignClientFallbackFactory.class)
