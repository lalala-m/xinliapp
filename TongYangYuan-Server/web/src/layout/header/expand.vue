...
<template>
  <div class="rr-header-right-items">
    ...
    <div style="display: flex; justify-content: center; align-items: center">
      <img v-if="store.state.user.avatar" :src="store.state.user.avatar" :alt="props.userName" style="width: 30px; height: 30px; border-radius: 50%; margin-top: 3px; margin-right: 5px; object-fit: cover" />
